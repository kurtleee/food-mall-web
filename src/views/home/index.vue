      ...
      <el-row :gutter="20">
        <el-col :span="6">
          <div class="out-border">
            <div class="layout-title">蜗牛学院电商管理系统系统</div>
            <div class="color-main address-content">
              <a href="https://www.baidu.com" target="_blank">邓强个人资料</a>
            </div>
          </div>
        </el-col>
        <el-col :span="6">
          <div class="out-border">
            <div class="layout-title">视频中心</div>
            <div class="color-main address-content">
              <a href="https://www.woniuxy.com/note/22" target="_blank">邓强个人视频</a>
            </div>
          </div>
        </el-col>
        <el-col :span="6">
          <div class="out-border">
            <div class="layout-title">刺激视频</div>
            <div class="color-main address-content">
              <a href="https://www.woniuxy.com/" target="_blank">点击此处进入</a>
            </div>
          </div>
        </el-col>
      </el-row>
